...
"""Build the printer set: CMYK PDF/X-4 and PDF/X-1a, separates and 2-page.
    ...
    node "trifold-farmers/build/render-pdf.js"    # first, the vector PDFs
    python3 "trifold-farmers/build/make-pdfx.py"
    python3 "trifold-farmers/build/check-qr.py" "Trifold Design/print/<file>.pdf"

Produces one file to send and a folder of alternates nobody should have to
choose between:

    print/sfw-farmers-trifold-2page-CMYK-PDFX.pdf          X-4, both sheets. The file.
...
<x:xmpmeta xmlns:x="adobe:ns:meta/">
 <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about=""
   ...
   <dc:title><rdf:Alt><rdf:li xml:lang="x-default">Soil Food Web Foundation trifold, farmers</rdf:li></rdf:Alt></dc:title>
...
def main():
    ...
    for tag, convert, version in (("PDFX", to_cmyk_x4, "PDF/X-4"),
        ...
        for src in ("outside", "inside"):
            o = ALT / f"sfw-farmers-trifold-{src}-CMYK-{tag}.pdf"
            convert(ALT / f"sfw-farmers-trifold-{src}.pdf", o)
            finish(o, version)
            pages[src] = o
            built.append(o)
        m = (PRINT if tag == "PDFX" else ALT) / f"sfw-farmers-trifold-2page-CMYK-{tag}.pdf"
