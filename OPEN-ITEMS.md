...
Last updated 13 September 2026 (hero photograph, volunteer quotes cut, community photo slots, Salient brief). Placeholders render as dashed `.todo` blocks; add `?notes=1` to any page URL to reveal every one of them at once.
